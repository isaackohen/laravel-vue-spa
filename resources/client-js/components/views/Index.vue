            ...
            <div class="glide" id="slider">
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides" style="box-shadow: 0 7px 10px rgb(0 0 0 / 50%);">
                        <li class="glide__slide" style="background-image: url('https://games.cdn4.dk/treasurekey/treasurekey_banner2.png?auto=format&q=93')">
                        ...
                        <li class="glide__slide" style="background-image: url('https://games.cdn4.dk/treasurekey/treasurekey_banner3.png?auto=format&q=93')">
                            <div class="slideContent right">
                                <div class="slideContentWrapper">
                                    <div class="description">
